...
if (!PK) {
  console.error("ERROR: DEPLOYER_PRIVATE_KEY or FAUCET_PRIVATE_KEY environment variable is required");
  console.error("Set it in .env file or export DEPLOYER_PRIVATE_KEY=0x...");
  process.exit(1);
}
